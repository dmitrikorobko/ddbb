<?php
/**
 * The header layout 5 + not printable svg.
 *
 * @since   0.0.1
 * @package ddbb
 */
	...
	<header class="header-1">
		...
		<div class="menu">
			<div class="container">
                ...
                <div class="row addrow-contact d-lg-flex contact-phone">
                    <div class="col align-items-center justify-content-end d-flex">
                        ...
                        <?php if ( !empty($options['ddbb_text_field_additional_phone'] )){ ?>
                        <a class="phone" href="tel:<?php echo $options['ddbb_text_field_pr-country-code']; ?><?php echo $options['ddbb_text_field_additional_phone']; ?>" title=""><?php echo $options['ddbb_text_field_pr-country-code']; ?> <?php echo $options['ddbb_text_field_additional_phone']; ?></a>
                        <?php } ?>
                        </span>
                    </div>  
                </div>
				...
				<div class="row">
					...
					<div class="col-lg-2 d-flex align-items-center justify-content-end mob-contact">
						...
						<a class="d-none d-lg-flex vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-rounded vc_btn3-color-ddbb-button-1" href="<?php echo $options['ddbb_text_field_header-button-url']; ?>" title=""><?php echo $options['ddbb_text_field_header-button-text']; ?></a>
						<?php } ?>
						<?php mini_cart();?>
					</div>
				</div>
