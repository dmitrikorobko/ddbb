...
?>  
	...
	<?php } ?>
	<footer class="footer-3" <?php if ( !empty($options['ddbb_text_field_pr-footer-bg'] )){ ?>style="background-image: url(<?php echo $options['ddbb_text_field_pr-footer-bg']; ?>)" <?php }?>>          
        <div class="container">
			<div class="row information">
				<div class="col-lg-3 d-none d-lg-flex align-items-start justify-content-start">
                    <a href="<?php echo get_home_url(); ?>"><img src="<?php echo get_bloginfo('template_directory'); ?>/assets/svg/logo-black.svg" class="logo"></a>
                </div>
                <?php if ( !empty( $options['ddbb_text_field_pr-email'] ) || !empty( $options['ddbb_text_field_pr-phone'] ) ) { ?>
				<div class="col-md-4 col-lg-5 d-flex flex-row align-items-start justify-content-end contact">
                    <div>
				...
				<div class="col-md-4 col-lg-4 d-flex flex-row align-items-start justify-content-end social">
					<div>
